...
class QasrAlHukm extends StatelessWidget {
  const QasrAlHukm({super.key});

  final List<Map<String, String>> places = const [
    {
      "name": "قصر المصمك",
      "description": "معلم تاريخي",
      "image": "assets/masmak.jpg",
    },
    {
      "name": "سوق الزل",
      "description": "سوق تراثي",
      "image": "assets/al_zal.jpg",
    },
    {
      "name": "ميدان الصفاة",
      "description": "وجهة تراثية",
      "image": "assets/alsafaat.jpg",
    },
  ];
                  ...
                  onTap: () {
                    if (place["name"] == "قصر المصمك") {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const AlMasmakPalace(),
                        ),
                      );
                    }
                  },
...
class PlaceCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      // نفس حجم الكونتينر في HomeScreen
